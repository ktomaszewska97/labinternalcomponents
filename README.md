...
```
cd existing_repo
git remote add origin https://git.fortiss.org/best-energie/labinternalcomponents.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fortiss.org/best-energie/labinternalcomponents/-/settings/integrations)
